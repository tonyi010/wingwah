...
<nav class="navbar navbar-default">
    ...
    <div class="container">
      <ul class="nav navbar-nav nav-tab-left navbar-right nav-check">
        		<li><a href="about.php">關於榮華<span class="sr-only">(current)</span></a></li>
				<li><a href="china.php">國內發展</a></li>
				<li><a href="product.php">網上購物</a></li>
				<li><a href="shop.php">分店地址</a></li>
				<li><a href="video.php">分享視頻</a></li>
				<li><a href="contact.php">聯絡我們</a></li>
				<li class="visible-xs"><a href="login.php">登入</a></li>
				<li class="visible-xs"><a href="register.php">登記</a></li>
				<li class="visible-xs"><a href="checkout.php">購物籃</a></li>
      </ul>
    </div>
    </div><!-- /.navbar-collapse -->
</nav>