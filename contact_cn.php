...
<!-- mail -->
	<div class="mail animated wow zoomIn" data-wow-delay=".5s">
		<div class="container">
		<p style="color:#FB6703; font-size:32px">联络我们</p><br><br>
			<div class="mail-grids">
				<div class="col-md-8 mail-grid-left animated wow slideInLeft" data-wow-delay=".5s">
					<form id="enquiry" method="POST">
						...
						<div class="form-group has-feedback">
							<input class="required form-control" type="email" id="eemail" name="email" placeHolder="电邮地址" required>
							<span class="glyphicon glyphicon-warning-sign form-control-feedback"></span>
						</div>
						<div class="form-group has-feedback">
							<input class="required form-control" type="text" id="esubject" name="subject" placeHolder="主题" required>
							<span class="glyphicon glyphicon-warning-sign form-control-feedback"></span>
						</div>
						<div class="form-group has-feedback">
							<textarea class="required form-control" type="text" id="emessage" name="message" placeHolder="内容..." required></textarea>
							<span class="glyphicon glyphicon-warning-sign form-control-feedback"></span>
						</div>
						<div id="mail_submit">送出</div><span id="success"></span>
					</form>
				</div>
				<div class="col-md-4 mail-grid-right animated wow slideInRight" data-wow-delay=".5s">
					<div class="mail-grid-right1">
						<img src="<?php asset('images/3.png') ?>" alt=" " class="img-responsive" />
						<h4>荣华参茸中西药房<br />Wing Wah Dispensary</h4>
						<ul class="phone-mail">
